...
export default function HomeBody() {
  ...
  {
    title: "Hello Beginner Sheet",
    description: "Most Beginner Level Questions",
    color: `${isDark?'bg-gray-900':'bg-white'} border border-green-100`,
    accent: `${isDark?'text-green-300':'text-green-800'}`,
